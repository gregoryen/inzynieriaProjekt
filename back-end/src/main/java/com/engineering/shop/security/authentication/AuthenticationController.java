...
public class AuthenticationController {
    ...
    public ResponseEntity logIn(@RequestBody UserSignInPOJO authenticationDetails) throws Exception {
        ...
        return ResponseEntity.ok(new JwtResponse(token,jwtUtil.getStringClaimFromToken(token,"name"),jwtUtil.getStringClaimFromToken(token,"lastName"), jwtUtil.getStringClaimFromToken(token,"privileges"), jwtUtil.getStringClaimFromToken(token,"role")));
    }
